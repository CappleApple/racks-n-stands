...
public final class FixtureItemExtractEvent extends Event implements ICancellableEvent {
    public final DisplayFixture fixture;public final int slot;private final ItemStack stack;
    public FixtureItemExtractEvent(DisplayFixture fixture,int slot,ItemStack stack) { this.fixture=fixture;this.slot=slot;this.stack=stack.copy(); }
